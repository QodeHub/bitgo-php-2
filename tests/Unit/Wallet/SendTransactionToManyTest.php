...
class SendTransactionToManyTest extends TestCase
{
    ...
    public function the_create_address_method_can_be_called_with_an_entry_static_coin_method()
    {
         ...
         */
        $instance = Bitgo::{$this->coin}()->wallet($this->walletId)->buildTransaction();
    ...
    public function the_instace_should_have_a_wallet_id_when_called_from_a_wallet_instance()
    {
        ...
        /**
         * Call the BuildTransaction Magic method on the wallet instance
         */
        $BuildTransactionInstance = $wallet->buildTransaction();

        /**
         * Assert that the BuildTransaction Instance received the wallet ID
         */
        $this->assertEquals($BuildTransactionInstance->getWalletId(), $this->walletId);
