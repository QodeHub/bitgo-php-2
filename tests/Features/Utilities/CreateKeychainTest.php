...
use Qodehub\Bitgo\Utilities\CreateKeychain;
use Qodehub\Bitgo\Utility\BitgoHandler;

class CreateKeychainTest extends TestCase
{
    /**
    ...
    public function a_call_to_the_run_method_should_return_an_error_if_the_coin_value_is_missing()
    {
         ...
         */
        $mock = $this->getMockBuilder(CreateKeychain::class)
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the CreateKeychain class method and use the interceptor
         *
        ...
        $this->assertContains(
            "https://some-host.com/api/v2/" . $this->coin . "/keychain/local",
