...
use Qodehub\Bitgo\Utilities\Decrypt;
...
class DecryptTest extends TestCase
{
    ...
    {
        /**
         * Mock the execute method in the Decrypt to intercept calls to the server
         */
        $mock = $this->getMockBuilder(Decrypt::class)
            ->setMethods(['execute'])
            ->getMock();
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the Decrypt class method and use the interceptor
         *
        ...
        $this->assertContains(
            "https://some-host.com/api/v2/decrypt",
