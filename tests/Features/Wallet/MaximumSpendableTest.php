...
use Qodehub\Bitgo\Wallet\MaximumSpendable;

class MaximumSpendableTest extends TestCase
{
    /**
    ...
    {
        /**
         * Mock the execute method in the MaximumSpendable to intercept calls to the server
         */
        $mock = $this->getMockBuilder(MaximumSpendable::class)
            ->setMethods(['execute'])
            ->getMock();
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the MaximumSpendable class method and use the interceptor
         *
        ...
        $this->assertContains(
            "https://some-host.com/api/v2/tbtc/wallet/existing-wallet-id/maximumspendable",
