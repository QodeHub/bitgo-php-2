...
use Qodehub\Bitgo\Wallet\BuildTransaction;
...
class BuildTransactionTest extends TestCase
{
    ...
    {
        $instance = BuildTransaction::{$this->coin}();

        $this->assertInstanceOf(BuildTransaction::class, $instance);
    ...
    {
        /**
         * Mock the getClient method in the BuildTransaction to intercept calls to the server
         */
        $mock = $this->getMockBuilder(BuildTransaction::class)
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the BuildTransaction class method and use the interceptor
         *
        ...
        $this->assertContains(
            "https://some-host.com/api/v2/" . $this->coin . "/wallet/" . $this->walletId . '/tx/build',
