...
use Qodehub\Bitgo\Wallet\SendTransactionToMany;

class SendTransactionToManyTest extends TestCase
{
    /**
    ...
    {
        $instance = SendTransactionToMany::{$this->coin}();

        $this->assertInstanceOf(SendTransactionToMany::class, $instance);

        $this->assertEquals($instance->getCoinType(), $this->coin);
    }

    /** @test */
    public function it_should_throw_an_error_if_no_recipient_is_present()
    {
        /**
         * Mock the getClient method in the SendTransactionToMany to intercept calls to the server
         */
        $mock = $this->getMockBuilder(SendTransactionToMany::class)
    ...
    /** @test */
    public function a_call_to_the_run_method_should_return_an_error_if_the_recipients_contains_an_invalid_recipient()
    {
        /**
         * Mock the getClient method in the SendTransactionToMany to intercept calls to the server
         */
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the SendTransactionToMany class method and use the interceptor
         *
        ...
        $this->assertContains(
            "https://some-host.com/api/v2/" . $this->coin . "/wallet/" . $this->walletId . '/sendmany',
