...
class RemoveWebhookTest extends TestCase
{
    ...
    {
        /**
         * Mock the getClient method in the RemoveWebhook to intercept calls to the server
         */
        $mock = $this->getMockBuilder(RemoveWebhook::class)
    ...
    /** @test */
    public function a_call_to_the_run_method_should_return_an_error_if_the_type_value_is_missing()
    {
        /**
         * Mock the getClient method in the RemoveWebhook to intercept calls to the server
         */
    ...
    /** @test */
    public function a_call_to_the_run_method_should_return_an_error_if_the_type_url_is_missing()
    {
        /**
         * Mock the getClient method in the RemoveWebhook to intercept calls to the server
         */
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the RemoveWebhook class method and use the interceptor
         *
        ...
        $this->assertEquals($request->getMethod(), 'DELETE', 'it should be a post request.');
        ...
        $this->assertContains(
            "https://some-host.com/api/v2/" . $this->coin . "/wallet/" . $this->walletId . "/webhooks",
