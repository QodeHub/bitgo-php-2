...
class WebhooksTest extends TestCase
{
    ...
    {
        /**
         * Mock the getClient method in the Webhooks to intercept calls to the server
         */
        $mock = $this->getMockBuilder(Webhooks::class)
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the Webhooks class method and use the interceptor
         *
