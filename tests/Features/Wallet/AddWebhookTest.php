...
class AddWebhookTest extends TestCase
{
    ...
    {
        /**
         * Mock the getClient method in the AddWebhook to intercept calls to the server
         */
        $mock = $this->getMockBuilder(AddWebhook::class)
        ...
        $mock
            ...
            ->url($this->url)
            ->type($this->type)
            ->setNumConfirmations($this->numConfirmations)
            ->run();
    }
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
        ...
        /**
         * Listen to the AddWebhook class method and use the interceptor
         *
