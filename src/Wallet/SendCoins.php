...
class SendCoins extends Api
{
    ...
    protected $feeRate;
    /**
     *  Custom upper limit for fee rate in satoshis/litoshis/zatoshis/duffs 
     * per kilobyte, may be used to limit a fee rate estimate 
     * generated by means of numBlocks
     *
     * @var integer
     */
